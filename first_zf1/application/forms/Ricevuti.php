...
class Application_Form_Ricevuti extends Zend_Form {
	...
	public function init() {
		...
		$select->addMultiOptions($usr->getAllMessage($ricevuti = true));
		$this->addElement($select);
		
		$input = new Zend_Form_Element_Submit("submit_ricevuti");
		$input->setValue("ricevuti");
		$input->setLabel("Vedi");
